...
namespace Boombox
{
    ...
    class ACRCloudRecognizer
    {
        ...
        private string PostHttp(string url, IDictionary<string, Object> postParams)
        {
            ...
            var ENDBOUNDARY = System.Text.Encoding.ASCII.GetBytes("--" + BOUNDARYSTR + "--\r\n\r\n");
            ...
            foreach (var item in postParams)
            {
                if (item.Value is string)
                {
                    ...
                    byte[] tmpBytes = System.Text.Encoding.UTF8.GetBytes(tmpStr);
                ...
                else if (item.Value is byte[])
                {
                    ...
                    memStream.Write(System.Text.Encoding.UTF8.GetBytes("\r\n"), 0, 2);
                }
            }
            ...
            try
            {
                ...
                myReader = new StreamReader(response.GetResponseStream(), System.Text.Encoding.UTF8);
